	...
	tests := []struct {
	...
	}{
		{
			...
			input: FloatPos{
				...
				RightFromText:  new(uint64(20)),
				TopFromText:    new(uint64(30)),
				BottomFromText: new(uint64(40)),
				HAnchor:        new(stypes.AnchorPage),
				VAnchor:        new(stypes.AnchorText),
				XAlign:         new(stypes.XAlignCenter),
				YAlign:         new(stypes.YAlignInside),
				AbsXDist:       new(int(100)),
				AbsYDist:       new(int(200)),
			},
		...
		},
		{
			...
			input: FloatPos{
				LeftFromText: new(uint64(5)),
				HAnchor:      new(stypes.AnchorMargin),
				XAlign:       new(stypes.XAlignLeft),
				AbsXDist:     new(int(50)),
			},
